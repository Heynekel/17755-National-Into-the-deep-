...
import org.firstinspires.ftc.teamcode.AutonomosThings.Red.Red.AutonomosProcesRed;
...
public class AutonomoBlue  extends CommandOpMode {
    ...
    AutonomosProcesBlue autonomosProcesBlue;
    @Override
    public void initialize() {
        ...
        autonomosProcesBlue = new AutonomosProcesBlue(m_driveSubsystem, m_elevatorSystem, m_extensionIntakeSystem, m_intakeSystem, m_muñecaIntakeSystem, m_escalador);
        schedule(autonomosProcesBlue);
